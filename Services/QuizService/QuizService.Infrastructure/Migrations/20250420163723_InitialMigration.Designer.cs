...
namespace QuizService.Infrastructure.Migrations
{
    ...
    [Migration("20250420163723_InitialMigration")]
            ...
            modelBuilder.Entity("QuizService.Domain.Entities.Quiz", b =>
                {
                    b.HasOne("QuizService.Domain.Entities.Difficulty", "Difficulty")
                        .WithOne("Quiz")
                        .HasForeignKey("QuizService.Domain.Entities.Quiz", "DifficultyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuizService.Domain.Entities.QuizStatus", "Status")
                        .WithOne("Quiz")
                        .HasForeignKey("QuizService.Domain.Entities.Quiz", "QuizStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("QuizService.Domain.Entities.Tag", "Tag")
                        .WithOne("Quiz")
                        .HasForeignKey("QuizService.Domain.Entities.Quiz", "TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

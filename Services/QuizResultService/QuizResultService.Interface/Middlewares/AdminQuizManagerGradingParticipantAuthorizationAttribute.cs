...
public class AdminQuizManagerGradingParticipantAuthorizationAttribute : Attribute, IAuthorizationFilter
{
    public void OnAuthorization(AuthorizationFilterContext context)
    {
        ...
        if (!roles.Any(r =>
                r.Equals("admin_quiz_manager", StringComparison.OrdinalIgnoreCase) ||
                r.Equals("admin_grading", StringComparison.OrdinalIgnoreCase) ||
